...
try:
    url = ('https://www.bilibili.com/video/BV1Bu411a7Ht/?spm_id_from=333.1007.top_right_bar_window_custom_collection'
           '.content.click')
    headers = {
    ...
    data1 = requests.get(url=url, headers=headers).text
...
c = ''.join(title1)
print(c)
data_1 = soup.select('script')[2].get_text()
# print(data_1)
result_data = data_1.split('=', 1)[1]
# print(result_data)
v1 = json.loads(result_data)
# print(v1)
audio_url12 = v1['data']['dash']['video'][0]
print(audio_url12)
