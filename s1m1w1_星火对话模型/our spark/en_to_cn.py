...
'''
APPId = "a46b46f0"
APISecret = "NDYyNjc5MTY2MTYxNDhhZmE1OThjNmMx"
APIKey = "a4e19bb502227240bb9372cad4a5572a"
...
def to_cn(content):
    ...
    body = {
        ...
        "payload": {
            "input_data": {
                "encoding": "utf8",
                "status": 3,
                "text": base64.b64encode(content.encode("utf-8")).decode('utf-8')
            }
        }
    }
    ...
    src_content = data['trans_result']['src']
    dst_content = data['trans_result']['dst']

    # print("src的内容:", src_content)
    # print("dst的内容:", dst_content)
    # print('text字段Base64解码后=>' + base64.b64decode(tempResult['payload']['result']['text']).decode())
