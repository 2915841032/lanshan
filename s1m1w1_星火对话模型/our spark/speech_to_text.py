...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, AudioFile):
        ...
        self.BusinessArgs = {"domain": "iat", "language": "en_us", "vinfo":1,"vad_eos":10000}
...
if __name__ == "__main__":
     audio_file_name = 'picture_talk_en.pcm'
     result = speech_to_text(audio_file_name)
     print(result_txt)
...
#         # super(SpeechToText, self).__init__(APPId, APISecret, APIKey, AudioFile)
#         self.APPID = APPID
#         self.APISecret = APISecret
#         self.APIKey = APIKey
#         self.AudioFile = AudioFile
...
#     def run(self):
#         result_txt = ''
#         self.wsParam = Ws_Param(self.APPID, self.APISecret, self.APIKey, self.AudioFile)
#         websocket.enableTrace(False)
