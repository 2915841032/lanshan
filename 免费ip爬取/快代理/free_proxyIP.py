...
def validate(ip):
    ...
    try:
        r = requests.get('https://www.baidu.com/', proxies=IP,
...
def get_proxy():
    with open('IP/validate.csv', mode='r', encoding='utf-8', newline='') as f:
        datas = f.readlines()
...
def main():
    ...
    writer.writerow(['ip'])
    url = 'https://www.kuaidaili.com/free/dps/{}/'  # 这是网站的 url
    for i in range(1, 11):  # 爬取四十页
        time.sleep(1)  # 休息 1 秒
