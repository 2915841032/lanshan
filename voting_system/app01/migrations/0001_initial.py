# Generated by Django 3.2.25 on 2025-02-26 09:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(db_column='sno', on_delete=django.db.models.deletion.PROTECT, to='app01.subject', verbose_name='所属学科')),
            ],
            options={
                'verbose_name': '老师',
